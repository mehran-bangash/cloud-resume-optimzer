...
export function useResumeForm() {
  ...
  // Start optimized resume as null so the live preview displays the user's edits instantly
    ...
    try {
      ...
      if (data.success && data.optimized) {
        ...
        const fullyCompiledResume: ResumeModel = {
          ...resume, // Preserve current user contact details (e.g. customized name Zain)
          ...parsedResume,
        };
...
### File 2: Updated View Page (Dashboard with Draft vs AI Viewer Tabs)
Replace the entire contents of **`src/app/page.tsx`** with this file. It now features instant user input binding on the preview pane and a dedicated tab for your AI-suggested results!

```react:SaaS Dashboard Page:src/app/page.tsx
"use client";
